...
export const Cart: React.FC = () => {
    ...
    if (!cartIsEmpty) {
            ...
            <table className={bem('Table', ['table'])}>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td data-testid="total-price" className={bem('OrderPrice')}>${total}</td>
                    </tr>
                </tfoot>
            </table>
        );
        ...
        content = (
            <>
                Cart is empty. Please select products in the <Link data-testid="empty-cart-catalog-link" to="/catalog">catalog</Link>.
            </>
        );
    }
